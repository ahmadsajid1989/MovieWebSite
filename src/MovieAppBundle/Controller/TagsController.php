...
use MovieAppBundle\Entity\Tags;
use MovieAppBundle\Form\TagsType;
...
class TagsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MovieAppBundle:Tags')->findAll();

        return $this->render('MovieAppBundle:Tags:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MovieAppBundle:Tags:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MovieAppBundle:Tags')->find($id);
        ...
        return $this->render('MovieAppBundle:Tags:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MovieAppBundle:Tags:edit.html.twig', array(
            'entity'      => $entity,
